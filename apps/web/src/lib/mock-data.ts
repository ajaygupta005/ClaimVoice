...
export const mockExtractedFields: ExtractedField[] = [
  { label: 'Member ID',       value: 'CVX-0042-MT',     confidence: 98, source: 'demo', status: 'confirmed' },
  { label: 'Member Name',     value: 'Maya Thompson',   confidence: 96, source: 'demo', status: 'confirmed' },
  { label: 'Group Number',    value: 'GRP-DEMO',        confidence: 91, source: 'demo', status: 'confirmed' },
  { label: 'Plan Name',       value: 'Silver PPO 4500', confidence: 94, source: 'demo', status: 'confirmed' },
  { label: 'Carrier',         value: 'ClaimVoice Health', confidence: 88, source: 'demo', status: 'review' },
  { label: 'RX BIN',          value: '610014',          confidence: 82, source: 'demo', status: 'review' },
  { label: 'RX PCN',          value: 'CVPPO',           confidence: 85, source: 'demo', status: 'review' },
  { label: 'RX Group',        value: 'CVRX',            confidence: 86, source: 'demo', status: 'review' },
  { label: 'Effective Date',  value: '01/01/2026',      confidence: 92, source: 'demo', status: 'confirmed' },
]
